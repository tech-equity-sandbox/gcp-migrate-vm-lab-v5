...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-migrate-vm-lab-v5.sh` on the terminal.
...
This asset enables you to perform the following activities:
 ...
 - Access Bastion Host
 - Enable API and Create Firewall Rules
 - Install Migrate to Virtual Machines Backend
 - Install MFCE Backend
 - Configure and Perform Migration
